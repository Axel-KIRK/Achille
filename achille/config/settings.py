...
MAX_ASSISTED_PINGS_PER_DAY = 2
JOURNAL_ARCHIVE_AFTER_DAYS = 1
BELIEF_SHIFT_THRESHOLD = 2
PENDING_EXPIRY_HOURS = 48
CONSOLIDATION_REPORT_PATH = "/data/last_consolidation_report.json"
CONSOLIDATION_PENDING_PATH = "/data/consolidation_pending.json"
